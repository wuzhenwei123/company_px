					...
					<div class="row">
						<div class="col-md-12">
							<form id="add_form" action="${ctx}/manageAdminUser/addManageAdminUser" method="post" class="form-horizontal">
								...
								<input type="hidden" id="departmentId" name="departmentId" value="${cDepartment.id}">
								<c:if test="${not empty cDepartment.parentIds}">
									<input type="hidden" id="departmentIds" name="departmentIds" value="${cDepartment.parentIds}">
								</c:if>
								<c:if test="${not empty cDepartment.parentIds}">
									<input type="hidden" id="departmentIds" name="departmentIds" value="${cDepartment.id}">
								</c:if>
								<div class="form-group">
