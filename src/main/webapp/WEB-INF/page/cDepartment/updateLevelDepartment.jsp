		...
		<div class="main-content">
			<section>
				<div class="container-fluid container-padded">
					<div class="row">
						<div class="col-md-12">
							<form id="add_form" action="${ctx}/cDepartment/updateCDepartment" method="post" class="form-horizontal">
								...
								<input type="hidden" id="id" name="id" value="${cDepartment.id}"/>
								<div class="form-group">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#add_form').bootstrapValidator({
	            ...
	            $.get("${ctx}/cDepartment/checkDepartmentCode?code="+document.getElementById("code").value+"&id=${cDepartment.id}",function(data){
	            	var json = eval("("+data+")");
	            	if(json.code=="1"){
	            		$.post($form.attr('action'), $form.serialize(), function(result) {
	    	            	if(result.code == 1){
	    		                parent.sys.success(result.message,'',function(){
	    		                	parent.setTreeNodeName(document.getElementById("name").value);
	    		                	P.close_win();
	    		                });
	    	            	}else{
