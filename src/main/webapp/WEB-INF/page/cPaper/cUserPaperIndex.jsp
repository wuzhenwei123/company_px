											...
											<div class="panel panel-plain">
									    		...
									    		<div class="panel-body" style="padding-top: 0px;">
										    		<div class="row">
										            	<div class="col-sm-12">
											    			<div id="toolbar">
														    	<perm:tag permPath="/cUserPaper/addCUserPaper" >
														    	<button type="button" onclick="to_add()" class="btn btn-primary">
															        <i class="glyphicon glyphicon-plus"></i>添加
															    </button>
																</perm:tag>
																<perm:tag permPath="/cUserPaper/removeAllCUserPaper" >
															...
															<table id="table" data-toggle="table"
														        ...
														        data-url="${ctx}/cUserPaper/getCUserPaperList?paperId=${cPaper.id}"
															    ...
															    <thead>
																    <tr>
																        ...
																        <th data-field="createTime" data-sort-name="createTime" data-align="center" data-formatter="formatterCreateTime" data-sortable="true">提交时间</th>
    ...
    <script type="text/javascript">
	    ...
	    function actionFormatter(value, row, index) {
	        return [
	            ...
	            '<perm:tag permPath="/cUserPaper/updateCUserPaper" >',
	            '<a class="edit" href="javascript:void(0)" title="编辑">',
	            '<i class="glyphicon glyphicon-edit"></i>',
	            '</a> | ',
	            '</perm:tag>',
	            '<perm:tag permPath="/cUserPaper/removeCUserPaper" >',
    	...
    	function toUpdate(id){
    		layer.open({
				title : "编辑",
			  	...
			  	area: ['60%', '80%'],
			  	shade: false,
			  	content: '${ctx}/cUserPaper/toUpdate/'+id 
			 });
    	}
    	function del(id){
   		   if (id != ""){ 
   				$.post("<c:url value='/cUserPaper/removeCUserPaper'/>",
	        	{
					id	:id,
					ranNum:Math.random()
				},
    	...
    	function del_all(){
   	    	...
   	    	if(ids && ids!=''){
	    		sys.confirm('确认全部删除',
	    				...
	    				'取消',
	    			function(){
	    	    	$.post("<c:url value='/cUserPaper/removeAllCUserPaper'/>",
	            	{
