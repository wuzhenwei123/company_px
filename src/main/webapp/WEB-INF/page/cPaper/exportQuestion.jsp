...
<body class="dig-body">
		...
		<div class="main-content">
			<section>
				<div class="container-fluid container-padded">
					<div class="row">
						<div class="col-md-12">
							<form id="add_form" action="${ctx}/cPaper/exportQuestion" method="post" class="form-horizontal">
								...
								<input type="hidden" id="paperId" name="paperId" value="${cPaper.id}">
								<div class="form-group">
	...
	<script type="text/javascript">
	 ...
	 function downloadTemplete() {
	 	window.location.href="${ctx}/cPaper/downloadExcel";
	 }
