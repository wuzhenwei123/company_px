		...
		<div class="main-content">
			<section>
				<div class="container-fluid container-padded">
					<div class="row">
						<div class="col-md-12">
							<form id="add_form" action="${ctx}/cUserPaperQuestion/addCUserPaperQuestion" method="post" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" id="paperId" name="paperId" class="form-control"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label">questionId：</label>
									<div class="col-md-7">
										<input type="text" id="questionId" name="questionId" class="form-control"/>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" id="isRight" name="isRight" class="form-control"/>
									</div>
								</div>
								<div class="form-group">
